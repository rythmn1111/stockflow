...
function DropdownMenuLabel({
  ...
  inset,
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Label> & { inset?: boolean }): React.JSX.Element {
  return (
...
function DropdownMenuSubTrigger({
  ...
  children,
  ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.SubTrigger> & { inset?: boolean }): React.JSX.Element {
  return (
...
function DropdownMenuSubContent({
  ...
  return <DropdownMenuPrimitive.SubContent data-slot="dropdown-menu-sub-content" className={cn(contentClasses, className)} {...props} />
}
